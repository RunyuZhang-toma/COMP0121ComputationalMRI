%% 12 layers of cylindrical array
% each layer of 32 elements circular array
...
for j=1:M
    R=d0/phim;    hm=(j-1)*d0;  
    %Circular array;
    %R=0.5*(M-j+1)*d0/phim;hm=(j-1)*d0/4;                                    
...
% calculate the a_cylinder, F_cylinder
...
% axis([-180,180,0,90,-threshold ,0]);
% set(gca,'xtick',[-180:60:180],'ytick',[0:30:90],'ztick',[-threshold :20:0]);
figure(3);
